...
### [rastro](https://github.com/PydaVi/rastro) · *active*
...
`Go` `AWS` `CSPM` `Attack Path Analysis` `IAM` `Cloud Security`

---

### [witness](https://github.com/PydaVi/witness) · *active*

🟡 active

HTTP/1.1 reverse proxy in Go from scratch — no frameworks, no abstractions. TCP accept loops, manual HTTP/1.1 parsing, concurrent load balancing with mutex-safe round-robin, circuit breakers as state machines, TLS termination.

The differentiator is **Narrative Mode** — instead of raw metrics, witness observes traffic patterns over time and surfaces what it notices in plain language, before it becomes a problem.
...
### [brainctl](https://github.com/PydaVi/brainctl) · *active*
...
### [brain-chaos](https://github.com/PydaVi/brain-chaos) · *frozen until witness v0.3*
...
Infrastructure & Cybersecurity Analyst at Suhai Seguradora — cloud environments, network security (FortiGate/Fortinet), EDR/SIEM operations, AWS architecture.
...
- [GitHub](https://github.com/PydaVi)
- [augustt.fabio@gmail.com](mailto:augustt.fabio@gmail.com)
